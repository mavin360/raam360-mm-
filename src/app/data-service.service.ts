...
export class DataService {
  ...
  domain = 'http://35.185.240.172/nkd/reportIndex.php';
  ...
  getDashboardByDate(f,l){
	  var url='http://35.185.240.172/nkd/reportIndex.php/Dashboard/SD/'+f+'/ED/'+l;
	return this.http.get(url)
                    .map( (res: Response) => res.json() )
                    .catch( (error: any) => Observable.throw(error.json().error || 'server error') );
  }
  
  getCountryDashboardByDate(id,f,l): Observable<any>{
		 var url = 'http://35.185.240.172/nkd/reportIndex.php/Dashboard/Country/'+id+'/SD/'+f+'/ED/'+l;
    ...
    getStoreDashboardByDate(id,f,l): Observable<any>{
    var url = 'http://35.185.240.172/nkd/reportIndex.php/Dashboard/Store/'+id+'/SD/'+f+'/ED/'+l;;
